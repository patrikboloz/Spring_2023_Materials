// The program computes the first 20 Fibonacci numbers and the corresponding
// Fibonacci quotients
...
string header = " Index  Fibonacci number  Fibonacci quotient  Deviation of limit"
                "\n --------------------------------------------------------------";
...
int main()
{
	...
	for (i=2; i <= COUNT; i++)
	{
		...
		cout << setw(5) << i << setw(15) << fib[i]
		     ...
		     << setw(20) << scientific << setprecision(3) << lim - q << endl;
	}
	return 0;
}
